...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='EventBooking',
            fields=[
                ('search_id', models.UUIDField(default=uuid.UUID('826a97d9-682f-4224-8a57-b2f58f20685f'), editable=False, primary_key=True, serialize=False, verbose_name='ID de busqueda')),
