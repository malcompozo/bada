# Generated by Django 4.0.3 on 2022-06-09 04:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('event_booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eventos_reservados', to='bada_app.eventbooking')),
            ],
            options={
