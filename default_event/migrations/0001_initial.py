# Generated by Django 4.0.3 on 2022-05-24 04:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description2', models.CharField(blank=True, max_length=100, null=True, verbose_name='Descripción2')),
                ('value', models.PositiveIntegerField(verbose_name='Valor')),
                ('eventType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_entertainment', to='default_event.eventtype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description2', models.CharField(blank=True, max_length=100, null=True, verbose_name='Descripción2')),
                ('value', models.PositiveIntegerField(verbose_name='Valor')),
                ('eventType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_drinks', to='default_event.eventtype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.PositiveIntegerField(verbose_name='Valor')),
                ('eventType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_catering', to='default_event.eventtype')),
            ],
            options={
